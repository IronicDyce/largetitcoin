...
<section className="relative py-20 md:py-32 overflow-hidden bg-black text-white">
        ...
        <div className="container mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
            ...
            <p className="text-lg text-gray-300 mt-6 px-4 py-3 border border-[#14da3f] rounded-lg inline-block whitespace-pre-line">
              {siteConfig.description}
            </p>

            <div className="flex flex-wrap justify-center md:justify-start gap-4 my-8">
              <a href={siteConfig.buyLink} className="bg-gradient-to-r from-[#14da3f] to-green-500 text-white font-bold px-6 py-3 rounded-md shadow transform transition-transform duration-200 hover:scale-105">
                {siteConfig.ctaText} <span className="ml-2">→</span>
              </a>
              <a href={siteConfig.chartLink} className="border-2 border-[#14da3f] text-[#14da3f] px-6 py-3 rounded-md transform transition-transform duration-200 hover:scale-105">
                View Chart ↗
              </a>
            </div>

            <div className="grid grid-cols-2 gap-4 max-w-xs mx-auto md:mx-0">
              {siteConfig.stats.map((item, i) => (
                <div
                  key={i}
                  className="bg-black/60 backdrop-blur-md rounded-lg p-3 border border-[#14da3f] text-left w-full transform transition-transform duration-200 hover:scale-105"
                >
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 grid gap-6">
              {[
                ...
                <div key={idx} className="bg-black/60 border border-[#14da3f] p-4 rounded-lg hover:scale-105 transform transition duration-200">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <div key={idx} className="bg-black/60 border border-[#14da3f] p-3 rounded-lg hover:scale-105 transform transition duration-200">
      ...
      <section id="Roadmap" className="bg-black text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative border-l-2 border-[#14da3f] ml-4">
              {[1, 2, 3, 4].map((phase, idx) => (
                <div key={idx} className={`mb-12 pl-6 relative ${idx % 2 !== 0 ? 'ml-8' : ''}`}>
                  <div className="absolute -left-3 top-1 w-6 h-6 rounded-full bg-[#14da3f] text-black font-bold flex items-center justify-center">
                    {phase}
                  </div>
                  <div className="bg-black/60 border border-[#14da3f] rounded-lg p-4 text-left shadow-md">
